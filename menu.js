...
let foodArr = [
    ...
    name: 'healthy crap',
    price: 11.99,
    category: 'fresh stuff',
    popularity: 80,
    rating: 4,
    tags: ['cucumbers', 'strawberry', 'brussel sprouts', 'eggplant']
    },
    {
    name: 'the sweats',
    price: 12.99,
    ...
    popularity: 50,
    rating: 2.5,
    tags: ['vegan', 'spicy dips', 'cauliflower', 'bread crumbs']
    },
    {
    name: 'casseroli',
    price: 16.99,
    ...
    popularity: 40,
    rating: 2,
    tags: ['little green trees', 'rice', 'cheese', 'challots']
    }
]
...
//CODE HERE
const filteredFood = foodArr.filter(elem => elem.tags.includes('challots'));
