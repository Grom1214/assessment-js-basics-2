...
const firstTicket = new Ticket('hotdog and a hotpocket', '7:19', 1024);
/*
...
//CODE HERE
 ...
 firstTicket.updateStatus('Done')
 firstTicket.updateStatus('on fire :(')
 firstTicket.updateStatus('Gone');